...
class DroneOptimizer(object):
    def __init__(self, d_model, d_constraint, t_horizon, n_nodes):
        ...
        Q = np.diag([2000, 2000, 5000, 0, 0, 0, 0, 0, 0, 200, 0, 0, 0, 0, 0, 0, 0])
        ...
        ocp.constraints.lbx = np.concatenate((np.array([d_constraint.z_min, d_constraint.T_min]), d_constraint.w_min))
        ocp.constraints.ubx = np.concatenate((np.array([d_constraint.z_max, d_constraint.T_max]), d_constraint.w_max))
        ...
        ocp.constraints.lbu = np.concatenate((np.array([d_constraint.dT_min]), d_constraint.dw_min))
        ocp.constraints.ubu = np.concatenate((np.array([d_constraint.dT_max]), d_constraint.dw_max))
